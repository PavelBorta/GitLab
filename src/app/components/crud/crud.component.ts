...
export class CrudComponent implements OnInit {
  ...
  async selectUser(user: User) {
    this.user = await this.usersService.get(user.id);
  }
  ...
  async create() {
    ...
    this.user = await this.usersService.create(this.user);
  ...
  async update() {
    ...
    const user = await this.usersService.update(this.user.id, this.user);
  ...
  async delete() {
    await this.usersService.delete(this.user.id);
